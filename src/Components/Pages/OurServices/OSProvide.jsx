  ...
  return (
    <div className="mt-10">
      ...
      <p style={{ fontFamily: "Ubuntu,sans-serif" }} className="text-lg my-5">
        ...
        ensure great experience for web users. <br /> Different types of web
        solutions may seem similar from the outside, but we approach them
        differently <br /> and know what factors are winning in each case.
      </p>
      <div className="grid lg:grid-cols-3 md:grid-cols-2 sm: grid-cols-1 gap-8 mt-10">
        {/* ---------------------  web App section --------------------- */}
        <div className="relative bg-gray-100 p-8 shadow-md hover:shadow-lg rounded-sm">
          ...
          <p className="text-center text-lg pb-10">
            In our portfolio of 230+ created web apps, you will find solutions
            for efficient management of different business activities. We apply
            smart automation to streamline workflows and integrate corporate
            apps together for coherent operation.
          </p>
          {/* Read More Button  */}
        ...
        <div className="relative bg-gray-100 p-8 shadow-md hover:shadow-lg rounded-sm">
          ...
          <p className="text-center text-lg pb-10">
            250+ businesses, governmental and non-profit organizations use the
            websites we’ve created for corporate presentation and brand
            building. We make sure our websites have an easy-to-use page editor
        ...
        <div className="relative bg-gray-100 p-8 shadow-md hover:shadow-lg rounded-sm">
          ...
          <p className="text-center text-lg pb-10">
            With 4 years in eCommerce development, we've evolved from
            entry-level solutions for startups to custom platforms for
            large-scale businesses. Our focus on scalable microservices and high
            automation enhances business efficiency.
          </p>
          {/* Read More Button  */}
          <div title="Read More" className="absolute bottom-2 right-3 py-3 ">
            <button className="flex items-center gap-1 text-purple-900 hover:text-purple-300 rounded-sm ps-2">
