...
import icon1 from "../../../../public/Icons/webApp.png";
import icon2 from "../../../../public/Icons/software.png";
import icon3 from "../../../../public/Icons/erp.png";
        ...
        <div className="mt-10">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 sm: grid-cols-1 gap-8 mt-10">
            ...
            <div className=" bg-gray-100 p-8 shadow-md hover:shadow-lg rounded-sm">
              ...
              <p className="text-start text-md uppercase">
