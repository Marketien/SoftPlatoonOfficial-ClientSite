  ...
  return (
    <div className="bg-gray-100 py-[80px] lg:mx-auto md:mx-7 sm: mx-4 ">
      ...
      >
        ...
        >
          Secure the Success of Your<span className="text-purple-900 ms-1 "> IT Initiative</span>
        </h1>
        <p
          data-aos="fade-right"
          data-aos-duration="1000"
        ...
        >
         As a tech partner, SoftPlatoon takes on a mission of achieving your project success no matter what. 
         Check the tried-and-true project management practices we rely on to drive the project to its goals despite budget 
...
<div key={index}>
<h1 style={{ fontFamily: "Open Sans, sans-serif" }} className="underline text-2xl font-semibold hover:text-[#793ea7] mb-5"> {title}</h1>
<p style={{ fontFamily: "Ubuntu,sans-serif" }} className="text-lg ">{disc}</p>
</div>
            ))}
        </div>
      </div>
