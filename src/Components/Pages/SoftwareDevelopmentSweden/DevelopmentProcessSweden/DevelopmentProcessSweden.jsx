  ...
  return (
    <div className=" py-[60px] lg:mx-auto md:mx-7 sm: mx-4 ">
      ...
      >
        ...
        <div
          data-aos="fade-up"
          className="mt-10 grid lg:grid-cols-1 md:grid-cols-1 sm: grid-cols-1 gap-8"
        >
