import img1 from "../../../../assets/Client Logo File/Qalaat Al Khaleej-Logo-01.png";
import img2 from "../../../../assets/Client Logo File/abroad1.png";
import img3 from "../../../../assets/Client Logo File/abroad2.png";
import img4 from "../../../../assets/Client Logo File/abroad3.png";
import img5 from "../../../../assets/Client Logo File/abroad4.png";
import img6 from "../../../../assets/Client Logo File/abroad5.png";
import img7 from "../../../../assets/Client Logo File/abroad6.png";
import img8 from "../../../../assets/Client Logo File/abroad7.png";
import img9 from "../../../../assets/Client Logo File/abroad8.png";
import clientImg1 from "../../../../assets/Images/Unknownclientjpg.jpg";
import clientImg2 from "../../../../assets/Images/client1.jpg";
import clientImg3 from "../../../../assets/Images/client2.jpg";
import clientImg4 from "../../../../assets/Images/client3.jpg";
import clientImg5 from "../../../../assets/Images/client5.png";
import clientImg6 from "../../../../assets/Images/client4.png";
import clientImg7 from "../../../../assets/Images/client8.png";
import clientImg8 from "../../../../assets/Images/client9.png";
...
const Testimonials = () => {
  ...
  return (
    <div style={{ fontFamily: "Open Sans,sans-serif" }} className="mt-32">
      <h1
      ...
      <div  className="lg:grid md:grid lg:grid-cols-2 md:grid-cols-1 sm: hidden gap-5 mt-10">
        {companies.slice(0, showAllData).map(
          (
            { img, clientImg, companyName, clientName, position, ReviewText },
            index
          ) => (
                  ...
                  <div className="relative flex items-center  ">
                    <div className="flex  gap-2 mb-5">
                      ...
                      <div>
                        ...
                        <p style={{ fontFamily: "Ubuntu,sans-serif" }} className="text-gray-500">{position}</p>
                      </div>
                    </div>
                  </div>
                  <p style={{ fontFamily: "Ubuntu,sans-serif" }}>{ReviewText}</p>
      ...
      <div className="sm: grid lg:hidden md:hidden sm: grid-cols-1 gap-5 mt-10">
        {companies.slice(0, showAllData).map(
          (
            ...
            <div key={index} className="shadow-md border-t-2 px-3 py-8">
