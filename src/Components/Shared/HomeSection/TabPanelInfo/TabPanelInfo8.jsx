...
const TabPanelInfo8 = () => {
    ...
    const CybersecurityServices = tabInfos.find(
        (info) => "CybersecurityServices" in info
      );
    ...
    return (
        ...
        {CybersecurityServices && (
          <div className="md:px-5 sm: px-4 md:py-0 sm: py-10 lg:h-full md:h-[600px] sm: h-[750px]" style={{ fontFamily: "Open Sans,sans-serif" }}>
            ...
            >
              {CybersecurityServices.CybersecurityServices.title}
            </h2>
            <p className="ffont-medium md:text-lg sm: text-md leading-8 mt-5">
              {CybersecurityServices.CybersecurityServices.paragraph}
            </p>
            <ul className="flex justify-between items-center font-medium text-lg leading-10 mt-5">
              <li>
                {CybersecurityServices.CybersecurityServices.points.map(
                  (point, index) => (
